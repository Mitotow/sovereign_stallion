...
class IntroCinematic:
    def __init__(self, screen):
        ...
        self.subtitles = [
            {"start": 5500, "end": 8500, "text": "Qu'est-ce qu'un gueerier sans son étalon ?"},
            {"start": 9500, "end": 12000, "text": "Qu'est-ce qu'un lion sans sa crinière ?"},
            {"start": 13000, "end": 16000, "text": "Qu'est ce que la pluie sans les nuages pour les trasnporter ?."},
